  ...
  return (
    <footer className="bg-navy-950 text-white/70">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex gap-4">
              ...
              <a href="https://github.com/vaultacloud" aria-label="GitHub" className="hover:text-white transition-colors">
        ...
        {/* Bottom bar */}
        <div className="border-t border-white/10 py-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs">
