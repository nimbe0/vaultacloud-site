...
export const metadata: Metadata = {
  title: 'VaultaCloud for government | VaultaCloud',
  alternates: { canonical: 'https://vaultacloud.com/use-cases/government' },
}
      ...
      <main>
        <section className="bg-hero grid-bg py-20">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <h1 className="section-title mb-4">VaultaCloud for government</h1>
